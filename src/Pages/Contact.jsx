...
export default function Contact() {
  return (
    ...
    <div className='lg:w-[1200px] w-full flex flex-col gap-2 m-auto px-2 mb-10' >
      ...
      <textarea className='border boder h-40 rounded-md px-2' name="" id="" placeholder='Message'></textarea>
    </div>

    <button className='bg-blue-600 block m-auto lg:w-[1200px] w-[400px] h-14   rounded-md text-white'>Submit</button>
  </div>
  </section>
