    ...
    <section className='py-10'>
        ...
        <div className='flex-wrap flex justify-center gap-5'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Living Room</h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Room</h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Kitchen</h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Family </h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Roof Top</h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
                <h1 className='mb-2 text-2xl font-normal'>Bathroom</h1>
                <div className=' mb-3'>
            ...
            <div className='lg:w-[600px] md:w-[390px] Buy  flex flex-col items-center bg-slate-300 md:px-2 px-3 md:mx-0 mx-2'>
             ...
             <div className='mb-3'>
             <img className='md:w-[580px] w-full h-[380px]' src={vid2} alt="" />
             </div>
